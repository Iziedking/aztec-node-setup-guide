...
### ⚠️ Free RPCs often cause connection issues.
...
* [Alchemy](https://alchemy.com) – RPC URL
* [Chainstack](https://console.chainstack.com) – Beacon URL
...
sudo docker logs $(docker ps -q --filter ancestor=aztecprotocol/aztec:alpha-testnet | head -n 1) \
  ...
  | head -n 1
```
• This outputs your node’s Peer ID.
• Paste it into [Nethermind Explorer](https://aztec.nethermind.io/) to verify your node

Validator Registration Stats:
After a successful registration, you can monitor your validator’s status and performance on [Aztec Scan](https://aztecscan.xyz/validators):
